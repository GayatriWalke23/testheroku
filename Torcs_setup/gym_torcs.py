...
class TorcsEnv:
    ...
    def __init__(self, vision=False, throttle=False, gear_change=False,race_mode = False,if_train = True,port_number=3001):
       #print("Init")
        self.vision = vision
    ...
    def step(self, u):
       #print("Step")
        ...
        self.observation = self.make_observaton(obs,obs2)
        ...
        return self.get_obs(), reward, client.R.d['meta'], {},obs['damage']
    ...
    def make_observaton(self, raw_obs,obs2):
        #print(raw_obs)
        #print(obs2)
