...
paths = {
    ...
    'policy_save_path'      : "Logs/Weights_Policy/policyweight_",
    'critic_save_path'      : "Logs/Weights_Critic/criticweight_",
...
#get port number of the torcs server
port_number = int(input("Enter the port number of the torcs server : "))


# Torcs - Gym 
env = TorcsEnv(vision=False, throttle=True, gear_change=True,port_number=port_number)
...
for i in range(2000):
    ...
    for j in range(100000):
        ...
        next_ob, r_t, done, info ,damage = env.step(action)
        ...
        if done:
            ...
            Agent.save_model(paths,port_number,total_rewards,j,total_damage)
            break
