...
from FL_Server.utils import launch_tensor_board

from FL_Server.models import *
from FL_Server.utils import *
from FL_Server.server import Server

if __name__ == "__main__":
    # read configuration file
    with open('./Utilities/config.yaml') as c:
    ...
    conn_config = configs[7]["conn_config"]
    ...
    central_server = Server(writer, model_config, global_config,data_config, init_config, fed_config, conn_config, optim_config)
